...
const RELEASE_LOCATIONS = ["Толгой","Хоолой","Цээж","Гэдэс","Гар","Хөл",];
const P2_SHAPES = ["Хатуу","Зөөлөн","Дүүрэн","Даралттай","Хөнгөн","Чангаралттай","Хөдөлгөөнтэй","Хөдөлгөөнгүй",];
...
const DEFAULT_COPY = {
  ...
  small_rules_body:
    "Алхам бүр дээр 1 минут орчим зогсоод биеэ ажигла. Зорилго нь энэ мэдрэжийг алга болгох биш хүлээн зөвшөөрөх.",
  timer_hint:
  ...
  ph_p4_insight: "Жнь: Би айдас байгааг мэдэрлээ, Айдас бол би биш. Tүүнийг миний биед байхыг хүлээн зөвшөөрч чадсан. Эсвэл: Aйдас маш хүчтэй орж ирлээ би байж сууж чадахгүй хяналтаа алдаж өөр юм хийсэн (босож явсан өөр дуу сонссон утсаа харсан гэх мэт...)",
  btn_back: "Буцах",
  ...
  p4_reflect_li2: "Асуулт: “Би өнөөдөр юуг мэдэрч, юуг засахгүйгээр зөвшөөрөв?”",
  p4_reflect_li3:
